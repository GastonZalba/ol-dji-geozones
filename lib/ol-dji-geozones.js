...
class DjiGeozones {
  ...
  _createPanel(createPanel, startCollapsed, targetPanel) {
    ...
    var addMapControlFull = () => {
      ...
      this.divControl.innerHTML = "\n            <header>\n                <h3>".concat(this.options.i18n.labels.djiGeoZones, "</h3>\n                <span class=\"ol-dji-geozones--loading\">\n                    ").concat(this.options.loadingElement, "\n                </span>\n            </header>\n            <main>\n                <section class=\"ol-dji-geozones--selectors\"></section>\n                <section>\n                    <div class=\"ol-dji-geozones--logo\" title=\"").concat(this.options.i18n.labels.expand, "\"><img src=\"").concat(img, "\"/></div>\n                    <span class=\"ol-dji-geozones--advice\">").concat(this.options.i18n.labels.helperZoom, "</span>\n                </section>\n            </main>\n            ");
    ...
    var addMapControlCompact = () => {
      ...
      this.divControl.innerHTML = "\n            <header>\n                <span class=\"ol-dji-geozones--loading\">\n                    ".concat(this.options.loadingElement, "\n                </span>\n            </header>\n            <main>\n                <section>\n                    <div class=\"ol-dji-geozones--logo\" title=\"").concat(this.options.i18n.labels.showHide, "\"><img src=\"").concat(img, "\"/></div>\n                </section>\n            </main>\n            ");
      var logo = this.divControl.querySelector('.ol-dji-geozones--logo');
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      var showGeozoneDataInPopUp = (geozonesData, coordinates) => {
        ...
        var parseDataToHtml = responseApiArea => {
          ...
          var lbl = this.options.i18n.labels;
  ...
  getLevelById() {
    ...
    var texts = this.options.i18n.levels.find(lev => lev.id == id);

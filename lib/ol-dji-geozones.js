 ...
 * Built: Sun Apr 23 2023 13:20:49 GMT-0300 (Argentina Standard Time)
*/
...
class DjiGeozones extends Control {
    constructor(opt_options) {
        ...
        this._options = Object.assign({ urlProxy: '', buffer: 10000, drone: 'spark', zonesMode: 'total', country: 'US', displayLevels: [2, 6, 1, 0, 3, 4, 7], activeLevels: [2, 6, 1, 0, 3, 4, 7], createPanel: 'full', target: null, startCollapsed: false, startActive: true, dronesToDisplay: dronesList, extent: null, loadingElement: '<div class="lds-ellipsis"><div></div><div></div><div></div><div></div></div>', clickEvent: 'singleclick', language: DEFAULT_LANGUAGE, alert: null }, (opt_options || {}));

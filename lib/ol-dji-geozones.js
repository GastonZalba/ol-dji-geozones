        ...
        const apiResponseToFeatures = (djiJson) => {
            ...
            for (const area of areas) {
                ...
                if (area.polygon_points) {
                    const featureExtra = new Feature(Object.assign(Object.assign({}, featureProps), { geometry: new Polygon(area.polygon_points).transform('EPSG:4326', this.projection) }));
                    featureExtra.setId(area.area_id + '_poly');
                    features.push(fixLevelValue(featureExtra));
                }
                const feature = new Feature(Object.assign(Object.assign({}, featureProps), { geometry: new Point([area.lng, area.lat]).transform('EPSG:4326', this.projection) }));

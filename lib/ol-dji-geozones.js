...
import { MultiPolygon, Polygon, Point, Circle } from 'ol/geom';
import { Style, Fill, Stroke, Icon } from 'ol/style';
import { Control } from 'ol/control';
import { asArray, asString } from 'ol/color';
import { fromExtent } from 'ol/geom/Polygon';
import { getCenter, getBottomLeft, getTopRight, getBottomRight, getTopLeft } from 'ol/extent';
...
class DjiGeozones {
  ...
  _initialize() {
    ...
    var createVectorLayers = () => {
      ...
      API_LEVELS.forEach(level => {
        var props = {
          ...
          visible: this._hideGeozones ? false : this.activeLevels.includes(level) ? true : false,
    ...
    var createPopUpOverlay = () => {
      ...
      popupContainer.className = "ol-dji-geozones--ol-popup ol-dji-geozones--".concat(this.options.theme);
  ...
  _createPanel(createPanel, startCollapsed, targetPanel) {
    ...
    var addMapControlFull = () => {
      ...
      var logo = this.divControl.querySelector('.ol-dji-geozones--logo');
    ...
    var addMapControlCompact = () => {
      this.divControl.classList.add('ol-dji-geozones--ctrl-compact');
      this.divControl.innerHTML = "\n            <header>\n                <span class=\"ol-dji-geozones--loading\">\n                    ".concat(this.options.loadingElement, "\n                </span>\n            </header>\n            <main>\n                <section>\n                    <div class=\"ol-dji-geozones--logo\" title=\"").concat(this._i18n.labels.showHide, "\"><img src=\"").concat(img, "\"/></div>\n                </section>\n            </main>\n            ");
      var logo = this.divControl.querySelector('.ol-dji-geozones--logo');
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      var getInfoFromApiLatLng = coordinate => __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise(resolve => {
          setTimeout(() => __awaiter(this, void 0, void 0, function* () {
            ...
            var center4326 = transform(coordinate, this.projection, 'EPSG:4326');
            var clickLatLng = {
              lat: center4326[1],
              lng: center4326[0]
            };
      ...
      var showGeozoneDataInPopUp = (geozonesData, coordinates) => {
        var createTooltip = level => {
          ...
          infoTooltip.className = "ol-dji-geozones--info ol-dji-geozones--".concat(this.options.theme);
  ...
  getInfoFromView() {
      ...
      var _loop = function _loop(area) {
        ...
        if (area.polygon_points) {
          var featureExtra = new Feature(Object.assign(Object.assign({}, featureProps), {
            geometry: new Polygon(area.polygon_points).transform('EPSG:4326', _this.projection)
          }));
        ...
        var feature = new Feature(Object.assign(Object.assign({}, featureProps), {
          geometry: new Point([area.lng, area.lat]).transform('EPSG:4326', _this.projection)
          ...
          area.sub_areas.forEach(sub_area => {
            ...
            if (sub_area.polygon_points) {
              subFeature = new Feature({
                ...
                lng: sub_area.lng,
                lat: sub_area.lat,
                geometry: new Polygon(sub_area.polygon_points).transform('EPSG:4326', _this.projection)
              });
            } else {
              subFeature = new Feature({
                color: sub_area.color,
                ...
                lng: sub_area.lng,
                lat: sub_area.lat,
                geometry: new Circle([sub_area.lng, sub_area.lat], sub_area.radius / 100000).transform('EPSG:4326', _this.projection)
              });
            }
    ...
    setTimeout(() => __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        var center4326 = transform(center, this.projection, 'EPSG:4326');
        var viewLatLng = {
          lat: center4326[1],
          lng: center4326[0]
        };
    ...
    return __awaiter(this, void 0, void 0, function* () {
      var apiRequest = (typeApiRequest, _ref4, searchRadius) => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          var response = yield fetch(this.options.urlProxy + encodeURIComponent(url.toString()));
      ...
      var getAreas = (centerLatLng, searchRadius) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (this._areaDownloaded) {
          if (this._areaDownloaded.intersectsCoordinate(getCenter(extent)) && this._areaDownloaded.intersectsCoordinate(getBottomLeft(extent)) && this._areaDownloaded.intersectsCoordinate(getTopRight(extent)) && this._areaDownloaded.intersectsCoordinate(getBottomRight(extent)) && this._areaDownloaded.intersectsCoordinate(getTopLeft(extent))) {
          ...
          this._areaDownloaded = new MultiPolygon([polygon.getCoordinates()]);
        }
      ...
      var getMapRadius = (_ref5) => {
        ...
        var centerToSW = getDistance(center, posSW);
  ...
  static colorWithAlpha(color) {
    var alpha = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
    var [r, g, b] = Array.from(asArray(color));
    return asString([r, g, b, alpha]);
  }

}

export default DjiGeozones;

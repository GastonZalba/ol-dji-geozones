...
class DjiGeozones {
  ...
  _init() {
    ...
    var createPopUpOverlay = () => {
      ...
      popupContainer.className = "ol-dji-geozones--ol-popup ol-dji-geozones--".concat(this.theme);
    ...
    return __awaiter(this, void 0, void 0, function* () {
      var apiRequest = (typeApiRequest, _ref4, searchRadius) => {
        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          var response = yield fetch(this._urlProxy + encodeURIComponent(url.toString()));

...
-   Basic usage: create an OpenLayers map instance, and pass that map and options to the DjiGeozones constructor.
    -   [Full Panel](https://raw.githack.com/GastonZalba/ol-dji-geozones/v1.0.14/examples/basic.html)
    -   [Compact Panel](https://raw.githack.com/GastonZalba/ol-dji-geozones/v1.0.14/examples/basic_compact.html)
...
```HTML
<script src="https://unpkg.com/ol-dji-geozones@1.0.14"></script>
```

#### CSS

```HTML
<link rel="stylesheet" href="https://unpkg.com/ol-dji-geozones@1.0.14/dist/ol-dji-geozones.css" />
```
